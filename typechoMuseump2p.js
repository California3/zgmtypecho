    ...
    var alist = document.getElementsByClassName("needtochangepic");
        if(alist){
            for(var idx = 0; idx < alist.length; idx ++){
                var mya = alist[idx];
                lieeeeeee=mya.getAttribute("data-src");
                if(lieeeeeee!="https://www.6zgm.com/bg.jpg" && isInViewPortOfOne(mya)){
                    mya.setAttribute('src',lieeeeeee);
                    mya.setAttribute('data-src',"https://www.6zgm.com/bg.jpg");
                }
