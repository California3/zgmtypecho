    ...
    public static function parseCallback($matches){
        ...
        $providers = array(
            ...
            'v.youku.com' => array(
                ...
                'https://player.youku.com/player.php/sid/{video_id}/partnerid/d0b1b77a17cded3b/v.swf',
            ...
            'v.qq.com' => array(
                ...
                'https://static.video.qq.com/TPout.swf?vid={video_id}',
                'https://v.qq.com/iframe/player.html?vid={video_id}',
            ),
            'my.tv.sohu.com' => array(
                '#https?://my\.tv\.sohu\.com/us/(?:\d+)/(?<video_id>\d+)#i',
                'https://share.vrs.sohu.com/my/v.swf&topBar=1&id={video_id}&autoplay=false&xuid=&from=page',
                'https://tv.sohu.com/upload/static/share/share_play.html#{video_id}_0_0_9001_0',
            ),
            'www.wasu.cn' => array(
                '#https?://www\.wasu\.cn/play/show/id/(?<video_id>\d+)#i',
                'https://s.wasu.cn/portal/player/20141216/WsPlayer.swf?mode=3&vid={video_id}&auto=0&ad=4228',
                'https://www.wasu.cn/Play/iframe/id/{video_id}',
            ),
            'www.youtube.com' => array(
                '#https?://www\.youtube\.com/watch\?v=(?<video_id>[a-z0-9_=\-]+)#i',
                'https://playing.6zgm.com/v/{video_id}',
                'https://playing.6zgm.com/embed/{video_id}',
            ),
            'youtu.be' => array(
            ...
            'www.dailymotion.com' => array(
                ...
                'https://www.dailymotion.com/swf/video/{video_id}',
                'https://www.dailymotion.com/embed/video/{video_id}',
            ),
            'www.acfun.cn' => array(
                '#https?://www\.acfun\.cn/v/ac(?<video_id>\d+)#i',
                'https://cdn.aixifan.com/player/ACFlashPlayer.out.swf?type=page&url=http://www.acfun.cn/v/ac{video_id}',
                '',
            ),
            'www.acfun.tv' => array(
                '#https?://www\.acfun\.tv/v/ac(?<video_id>\d+)#i',
                'https://cdn.aixifan.com/player/ACFlashPlayer.out.swf?type=page&url=http://www.acfun.tv/v/ac{video_id}',
                '',
            ),
            'www.le.com' => array(
                '#https?://(?:[a-z0-9/]+\.)?(?:[le|letv])+\.com/ptv/vplay/(?<video_id>\d+)#i',
                'https://i7.imgs.letv.com/player/swfPlayer.swf?id={video_id}&autoplay=0',
                '',
            ),
            'www.letv.com' => array(
                '#https?://(?:[a-z0-9/]+\.)?(?:[le|letv])+\.com/ptv/vplay/(?<video_id>\d+)#i',
            ...
            'v.yinyuetai.com' => array(
                ...
                'https://player.yinyuetai.com/video/player/{video_id}/v_0.swf',
                '',
            ),
            'v.ku6.com' => array(
                '#https?://v\.ku6\.com/show/(?<video_id>[a-z0-9\-_\.]+).html#i',
                'https://player.ku6.com/refer/{video_id}/v.swf',
                '',
            ),
            'www.mgtv.com' => array(
                '#https?://www\.mgtv\.com/(?:[a-z0-9/]+)/(?<video_id>\d+)\.html#i',
                'https://player.mgtv.com/mango-tv3-main/MangoTV_3.swf?play_type=1&video_id={video_id}',
                '',
            ),
            'www.56.com' => array(
                '#https?://(?:www\.)?56\.com/[a-z0-9]+/(?:play_album\-aid\-[0-9]+_vid\-(?<video_id>[a-z0-9_=\-]+)|v_(?<video_id2>[a-z0-9_=\-]+))#i',
                'https://player.56.com/v_{video_id}.swf',
