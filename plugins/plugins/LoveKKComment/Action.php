...
class LoveKKComment_Action extends Widget_Abstract_Users implements Widget_Interface_Do
{
    ...
    private function html($act = 'forget', $form = NULL)
    {
        ...
        <body class="body-100" style="background-image:url('https://uploadbeta.com/api/pictures/random/?key=BingEverydayWallpaperPicture');">
        <!--[if lt IE 9]>
        ...
        <div class="typecho-login-wrap">
            <div class="typecho-login">
                <h1><a href="http://6zgm.com" class="i-logo">6zgm.com</a></h1>
                <?php $form->render(); ?>
            </div>
        </div>
