  ...
  /*  $url/plugin/hls.min.js*/
    public static function playerFooter()
    {
        ...
        if (Typecho_Widget::widget('Widget_Options')->plugin('DPlayer')->hls) {
            echo "<script type=\"text/javascript\" src=\"https://cdn.jsdelivr.net/npm/hls.js@latest\"></script>\n";
        }
...
<script type="text/javascript" src="$url/dist/init-dplayer.js"></script></section>
EOF;
    }
    ...
    public static function parseCallback($matches)
    {
        ...
        //输出代码
        $playerCode = '<div id="pjax-container"><div id="player' . $id . '" class="dplayer">';
        $playerCode .= "</div></div>\n";
